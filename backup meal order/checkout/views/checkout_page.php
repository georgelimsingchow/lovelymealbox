		...
		<div class="row">
			<div class="col-md-12">
			    <div class="panel panel-primary">
			      ...
			      <div class="panel-body">
						<div class="radio">
							<label> <input type="radio" name="payment_option" value="transfer" <?php echo set_radio('payment_option','transfer');?>> Cash On Delivery (Minimum RM 15.00)</label> 
						</div>			
						<div class="radio">
							<label> <input type="radio" name="payment_option" value="credit" <?php echo set_radio('payment_option','credit');?>> User Balance</label> 
						</div>
