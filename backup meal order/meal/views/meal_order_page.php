   ...
   <br>
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="row">
                          ...
                          <button type="button" class="btn btn-danger btn-block btn-lg" data-toggle="modal" data-target="#alacarte_modal">BUILD NOW</button>
                        <?php else: ?> 
                ...
                <div class="col-xs-12">
                    <!--SHIPPING METHOD-->
                    <div class="panel panel-default">
                        <div class="panel-heading text-center"><h4 style="margin: 0">Ala Carte (COMING SOON)</h4></div>
