      ...
      <div class="box-header with-border">
        ...
        <div class="box-body">
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <input type="text" class="form-control" placeholder="Steven Tsai" name="name" value="<?php echo set_value('name'); ?>">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <input type="text" class="form-control" placeholder="White Boy" name="nickname" value="<?php echo set_value('nickname'); ?>">
              <?php echo form_error('nickname', '<span class="help-block error-red">', '</span>'); ?>
            </div>
          </div>
          <div class="form-group">
