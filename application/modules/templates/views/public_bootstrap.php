...
<html lang="en">
  ...
  <meta property="og:url" content="http://www.lovelymealbox.com"/>
  <meta property="og:image" content="<?php echo base_url();?>assets/images/webbanner.jpg" />
  <meta property="og:title" content="饭盒最爱 | Lovely Meal Box 0109753899" />
  <meta property="og:description" content="您吃饱了吗?" />
    <title>饭盒最爱 | Lovely Meal Box</title>
 ...
 <!--  <link href="<?php echo base_url();?>assets/css/bootstrap.min.css" rel="stylesheet" type="text/css"> -->
  ...
  var test = '<?php echo base_url(); ?>';
  console.log(test);
//  global variable
var HTTP_HOST = window.location.host;
var channelURL = '';
if (HTTP_HOST == 'localhost.com') {
  channelURL = 'http://localhost.com/lovelymealbox';
}else{
  ...
  connectToFacebook = function() {
    FB.login(function(response) {
      if (response.authResponse) {
        ...
        // Now you can redirect the user or do an AJAX request to
        // a PHP script that grabs the signed request from the cookie.
        window.location.href = channelURL+"/login/fb_connect";
      } else {
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav" id="main_nav">        
        ...
        <li class="<?php if($this->uri->uri_string() == 'gallery') echo "active";?>"><a href="<?php echo base_url()?>gallery" class="menu_link" >GALLERY</a></li>
        ...
        <li class="dropdown <?php if($this->uri->segment(1) == 'catering') echo "active";?>">
          ...
          <ul class="dropdown-menu">
            <li><a href="<?php echo base_url()?>monthly-catering">MONTHLY CATERING</a></li>
            <li><a href="<?php echo base_url()?>buffet-catering">BUFFET CATERING</a></li>            
          </ul>
        </li>

        <li class="dropdown <?php if($this->uri->segment(1) == 'how') echo "active";?>">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">HOW ? <span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="<?php echo base_url()?>how-to-order">HOW TO ORDER</a></li>
            <li><a href="<?php echo base_url()?>how-to-reload">HOW TO RELOAD</a></li>            
          </ul>
        </li>
