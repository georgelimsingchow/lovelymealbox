...
$( document ).ready(function() {
	...
	$('#alacarte_modal').on('shown.bs.modal', function (e) {
		...
		$('#george').html('loading...').load('http://localhost.com/food_2_user/meal/ajax_alacarte?id='+id);
	...
	$('#alacarte_submit').click(function(e){
		...
		var url = "http://localhost.com/food_2_user/meal/ajax_add_alacarte";
	      e.preventDefault();
		    $.ajax({
		        url : url,
		        type: "POST",
	...
	$('#mealbox_submit').click(function(e){
		...
		// var url = "http://www.lovelymealbox.com/meal/ajax_meal_add";
		var url = "http://localhost.com/food_2_user/meal/ajax_meal_add";
	      e.preventDefault();
		    $.ajax({
		        url : url,
		        type: "POST",
