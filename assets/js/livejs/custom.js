$( document ).ready(function() {
	...
	$('#alacarte_modal').on('shown.bs.modal', function (e) {
		...
		$('#george').html('loading...').load('http://www.lovelymealbox.com/meal/ajax_alacarte?id='+id);
	...
	$('#alacarte_submit').click(function(e){
		var url = "http://www.lovelymealbox.com/meal/ajax_add_alacarte";
	      e.preventDefault();
		    $.ajax({
		        url : url,
		        type: "POST",
	...
	$('.del_item').click(function(e){
		var url = "http://www.lovelymealbox.com/meal/delete_item"
		e.preventDefault();
	...
	quantity_box.on('change',function(e){
		...
		$.ajax({
			url: 'http://www.lovelymealbox.com/cart/update',
			type: 'post',
...
var cart = {
	'remove' :function(key) {
		$.ajax({
			url: 'http://www.lovelymealbox.com/cart/remove',
			type: 'post',
			data: 'key=' + key,
			dataType: 'text',
			success: function(json) {
