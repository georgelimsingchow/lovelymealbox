		...
		<?php foreach ($cart_details as $date => $cart_value) { ?>
			...
			<?php foreach ($cart_value as $key => $value) { ?>
				...
				<tr id="<?php echo $value['id']; ?>">
					<td class='col-md-1 text-center' style='<?php echo $v_mid;?>'><?php echo $i ;?></td>
					<td class='col-md-3 text-center' style='<?php echo $v_mid;?>'>
					...
					<td class='col-md-1 text-center' style='<?php echo $v_mid;?>'> <?php echo $value['quantity']; ?></td>						
					<td class='col-md-1 text-center' style='<?php echo $v_mid;?>'><?php echo $value['total']; ?></td>					
				</tr>
			<?php } ?>
			</tbody>
			</table>
		...
		<?php } ?>
			<div class="row">
				<div class="col-md-5 pull-right">
					<ul class="list-group">
					  <li class="list-group-item">Delivery Fee : <span class="pull-right">RM <?php echo deliveryfee();?></span></li>
					  <li class="list-group-item">Total : <STRONG><span class="pull-right">RM <?php echo sprintf('%0.2f',$total_amount+deliveryfee());?></span></STRONG></li>
					</ul>
				</div>
			</div>
			<div class="row">
		...
		<div class="row">
			<div class="col-md-12">
			    <div class="panel panel-primary">
			      ...
			      <div class="panel-body">
						<div class="radio">
							<label> <input type="radio" name="payment_option" value="transfer" <?php echo set_radio('payment_option','transfer');?>> Bank transfer (Minimum order RM 20.00)</label> 
						</div>			
						<div class="radio">
							<label> <input type="radio" name="payment_option" value="credit" <?php echo set_radio('payment_option','credit');?>> Customer credit</label> 
						</div>
			...
			<div class="col-md-12">
			    <div class="panel panel-primary">
			      <div class="panel-heading">2. DELIVERY SESSION</div>
			      <div class="panel-body">
						<div class="radio">
							<label> <input type="radio" name="delivery_session" value="lunch" <?php echo set_radio('delivery_session','lunch');?>> Lunch (11:00AM ~ 01:00PM)</label> 
						</div>			
						<div class="radio">
							<label> <input type="radio" name="delivery_session" value="dinner" <?php echo set_radio('delivery_session','dinner');?>> Dinner (05:00PM ~ 07:00PM)</label> 
						</div>
