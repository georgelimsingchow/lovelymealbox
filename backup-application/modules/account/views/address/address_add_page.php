<div class="container">
    <div class="row">
		 <ol class="breadcrumb brand-danger">
		  ...
		  <li class="active">Create new address</li>
		</ol>
	</div>
	<div class="row">
   		<hr>
   		...
   		<form class="form-horizontal" action="<?php echo base_url();?>account/address/add" method="post">
   			<fieldset>
			...
			<div class="form-group">
	             ...
	             <div class="col-sm-10">
	               <input type="text" class="form-control" id="lname" placeholder="[Surname] or [Last name]" value="<?php echo set_value('lname'); ?>" name="lname">
			...
			<div class="form-group">
	             ...
	             <div class="col-sm-10">
	               <input type="text" class="form-control" id="mobile" placeholder="[Mobile number] e.g 012-3456789" value="<?php echo set_value('mobile'); ?>" name="mobile">
	               <?php echo form_error('mobile', '<p class="text-danger">', '</p>'); ?>
	             </div> 
			</div>
			<div class="form-group">
	             <label for="lname" class="col-sm-2 control-label">Address 1</label>
	             <div class="col-sm-10">
	               <input type="text" class="form-control" id="lname" placeholder="[House number/Lot number/Floor and Building Name]" value="<?php echo set_value('address_1'); ?>" name="address_1">
	               <?php echo form_error('address_1', '<p class="text-danger">', '</p>'); ?>
	             </div>
			</div>

			<div class="form-group">
	             <label for="lname" class="col-sm-2 control-label">Address 2</label>
	             <div class="col-sm-10">
	               <input type="text" class="form-control" id="lname" placeholder="[Street Name]" value="<?php echo set_value('address_2'); ?>" name="address_2">
	             </div>
	         </div>
			<div class="form-group">
	             <label for="city" class="col-sm-2 control-label">City/Town</label>
	             <div class="col-sm-10">
	             	<input type="text" class="form-control" id="city" name="city" placeholder="[City/Town] e.g kuching" value="<?php echo set_value('city'); ?>" name="city">
			...
			<div class="form-group">
	             ...
	             <div class="col-sm-10">
	             	...
	             	echo form_dropdown('state', $state,"",$js);
