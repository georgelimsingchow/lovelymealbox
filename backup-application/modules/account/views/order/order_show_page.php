				...
				<div class="panel-body">
					<div class="row">
						...
						<?php if($value['payment_option'] == 'transfer'){ ?>
							<div class="col-md-3">
								<strong>Please pay below:</strong>
								<ul class="list-unstyled">
	                                <li>Public Bank</li>
	                                <li>6407924334</li>
	                                <li> </li>
						   			...
						   			<tbody>
						   				<?php foreach ($value['order_details'] as $d_k => $d_v) { ?>
							   				<tr id="row<?php echo $d_v['order_product_id'];?>">
												<td class="text-left">
													<?php foreach ($d_v['selected_menu'] as $d_v_k => $d_v_v) { ?>
														<?php if ($d_v_k == 'meat') {?>
															<?php foreach ($d_v_v['eng'] as $d_v_v_k => $d_v_v_v) { ?>
																<a href="#" class="btn btn-danger"><?php echo $d_v_v_v;?></a>
															<?php }?>
														...
														<?php if ($d_v_k == 'vege') {?>
															<?php foreach ($d_v_v['eng'] as $d_v_v_k => $d_v_v_v) { ?>
																<a href="#" class="btn btn-success"><?php echo $d_v_v_v;?></a>
															<?php }?>
